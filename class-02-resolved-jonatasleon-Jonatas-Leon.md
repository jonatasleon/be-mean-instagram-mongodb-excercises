...
lucy(mongod-3.0.12) be-mean-pokemons> ls
function ls() { [native code] }
lucy(mongod-3.0.12) be-mean-pokemons> clear
2016-07-31T01:36:25.710-0300 E QUERY    ReferenceError: clear is not defined
    at (shell):1:1
lucy(mongod-3.0.12) be-mean-pokemons>
lucy(mongod-3.0.12) be-mean-pokemons> db.pokemons.find()
{
  "_id": ObjectId("579d7fc3cf09c5720e50ef15"),
  "attack": 110,
